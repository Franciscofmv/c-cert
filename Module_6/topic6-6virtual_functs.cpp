...
class Person : public Thing
{
   	public:
        ...
        void print();   // Automatically virtual from base class.
 ...
 {
   	public:
   	Politician( char *person_name, int person_age, 
   	char *pol_party );
   	void print();   // Automatically virtual from
                    	// base class.
 ...
 Politician::Politician
 	( char *person_name, int person_age,
 	char *pol_party ):
