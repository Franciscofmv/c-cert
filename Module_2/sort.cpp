...
int main(void)
{
    int i;   /* Loop variable. */ 
    int int_data[] =
       {16,2,31,47,9,21,83,50,77,25,11,14,41};
    int n_int_data = 13;
    float float_data[] =
       {16.6,2.2,31.1,47.7,9.9,21.1 ,83.3, 
        50.0, 77.7,25.5,11.1,14.4,41.1};
    int n_float_data =   13;
 
    sort(int_data,n_int_data); /* Invoke sort of
                                  int array. */
    cout << "int_data sorted:\n";
    for (i=0; i<n_int_data; ++i)
       cout << int_data[i] << endl;
	   
	sort(float_data,n_float_data);  /* Invoke sort
                                       of float
                                       array. */
...
void sort( int x[], int n )
{
    ...
    int last;     /* Index of last item to be
                     examined. */
    int i;        /* Loop over items to be
                     compared. */
