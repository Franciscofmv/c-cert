...
* DATE:        01/01/1998 
* LANGUAGE:    ANSI C
* PURPOSE:     Illustrate the use of smart objects in C.    
*/ 
...
int printf_distance( DISTANCE *this )   
{    
    return printf("%s=%ld'-%lf\"",this->name,                   
	               this->feet,                   
				   this->inches);   
}    
...
int scanf_distance( DISTANCE *this )   
{    
    return scanf("%ld'-%lf\"",&this->feet,                   
	              &this->inches);   
}    

int printf_weight( WEIGHT *this )   
{    
    return printf("%s=%ld#-%lfoz",this->name,                  
	               this->pounds,this->ounces);   
}
      
int scanf_weight( WEIGHT *this )   
{    
    return scanf("%ld#-%lfoz",&this->pounds,                  
	              &this->ounces);   
}